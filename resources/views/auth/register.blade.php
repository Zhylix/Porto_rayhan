<x-guest-layout>
    <form method="POST" action="{{ route('register') }}">
        ...
        <div class="flex min-h-full flex-col justify-center px-6 py-12 lg:px-8">
            ...
            <h2 class="mt-10 text-center text-2xl/9 font-bold tracking-tight text-white">Sign in to your account</h2><br>
        </div>
        ...
        <div class="flex items-center justify-end mt-4">
            <a class="underline text-sm text-blue-500 hover:text-white rounded-md focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500" href="{{ route('login') }}">
